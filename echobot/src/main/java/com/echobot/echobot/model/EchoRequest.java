...
public class EchoRequest {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.ips, echoRequest.ips) && Objects.equals(this.requestBody, echoRequest.requestBody)
				&& Objects.equals(this.terminateTime, echoRequest.terminateTime)
				&& Objects.equals(this.delayType, echoRequest.delayType);
	}

	@Override
	public int hashCode() {
		return Objects.hash(this.ips, this.requestBody, this.terminateTime, this.delayType);
	}
